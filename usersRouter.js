                                ...
                                (err, resultDateColectate) => {
                                  ...
                                  db.query(
                                    ...
                                    (err, resultDateParametri) => {
                                      ...
                                      db.query(
                                        `INSERT INTO Pacienti (id_parametru, id_colectie, id_medical, rol, cnp, nume, prenume, adresa, nr_tel, nr_tel_pers_contact, email, profesie, loc_munca, parola, varsta) VALUES (${
                                          resultDateParametri.insertId
                                        },${resultDateColectate.insertId},${
                                          resultDateMedicale.insertId
                                        }, ${db.escape(
                                          roles[req.body.rol]
                                        )}, ${db.escape(
                                          req.body.cnp
      ...
      function (error, results, fields) {
        ...
        return res
          ...
          .send({
            error: false,
            data: results,
            msg: "Cerere cu success pentru utilizatori.",
          });
      }
    );
  } catch (error) {
      ...
      function (error, results, fields) {
        ...
        return res
          ...
          .send({
            error: false,
            data: results,
            msg: "Cerere cu success pentru pacienti.",
          });
      }
    );
  } catch (error) {
      ...
      function (error, results, fields) {
        ...
        return res
          ...
          .send({
            error: false,
            data: results,
            msg: "Cerere cu success pentru supraveghetori.",
          });
      }
    );
  } catch (error) {
      ...
      function (error, results, fields) {
        ...
        return res
          ...
          .send({
            error: false,
            data: results,
            msg: "Cerere cu success pentru ingrijitori.",
          });
      }
    );
  } catch (error) {
        ...
        (error, results, fields) => {
          if (error) {
            ...
            return res
              ...
              .json({
                error: true,
                msg: "Eroare la stergerea utilizatorului!",
              });
          }
    ...
    function (error, results, fields) {
      if (error) {
        ...
        return res
          ...
          .json({
            error: true,
            msg: "Eroare la stergerea datelor din date_colectate.",
          });
      }
        ...
        function (error, results, fields) {
          if (error) {
            ...
            return res
              ...
              .json({
                error: true,
                msg: "Eroare la stergerea datelor din parametri_normali.",
              });
          }
            ...
            function (error, results, fields) {
              if (error) {
                ...
                return res
                  ...
                  .json({
                    error: true,
                    msg: "Eroare la stergerea datelor din date_medicale.",
                  });
              }
                ...
                function (error, results, fields) {
                  if (error) {
                    ...
                    return res
                      ...
                      .json({
                        error: true,
                        msg: "Eroare la stergerea tuturor datelor din istoric_date.",
                      });
                  }
                    ...
                    function (error, results, fields) {
                      if (error) {
                        ...
                        return res
                          ...
                          .json({
                            error: true,
                            msg: "Eroare la actualizarea datelor din supraveghetori.",
                          });
                      }
                        ...
                        function (error, results, fields) {
                          if (error) {
                            ...
                            return res
                              ...
                              .json({
                                error: true,
                                msg: "Eroare la actualizarea datelor din ingrijitori.",
                              });
                          }
                            ...
                            function (error, results, fields) {
                              if (error) {
                                ...
                                return res
                                  ...
                                  .json({
                                    error: true,
                                    msg: "Eroare la stergerea pacientului.",
                                  });
                              }
                              return res
                                .status(200)
        ...
        function (error, results, fields) {
          if (error) {
            ...
            return res
              ...
              .json({
                error: true,
                msg: "Eroare la cererea datelor medicale.",
              });
          }
          if (!results.length) {
            return res
        ...
        function (error, results, fields) {
          if (error) {
            ...
            return res
              ...
              .json({
                error: true,
                msg: "Eroare la cererea datelor colectate.",
              });
          }
          if (!results.length) {
            return res
              ...
              .json({
                error: true,
                msg: "Datele colectate nu au fost gasite.",
              });
          }
          return res.status(200).send({
            error: false,
...
router.get("/get-alarm-details/:id", checkTokenExistence, (req, res, next) => {
  try {
    ...
    try {
      ...
      db.query(
        ...
        function (error, results, fields) {
          ...
          const dateInLocalTime = new Date(results[0].timp).toLocaleString(
            "ro-RO"
          );
...
router.post("/get-parametri/:id", checkTokenExistence, (req, res, next) => {
  try {
    const userId = req.params.id;
    db.query(
      ...
      db.query(updateQuery, updateParams, function (error, results, fields) {
        if (error) {
          ...
          return res
            ...
            .json({
              error: true,
              msg: "Eroare la actualizarea datelor medicale",
            });
        }
        if (results.affectedRows === 0) {
          return res
      ...
      db.query(updateQuery, updateParams, function (error, results, fields) {
        if (error) {
          ...
          return res
            ...
            .json({
              error: true,
              msg: "Eroare la actualizarea datelor colectate.",
            });
        }
        ...
        db.query(istoricQuery, istoricData, function (err, results) {
          if (err) {
            ...
            return res
              ...
              .json({
                error: true,
                msg: "Eroare la actualizarea datelor istoric.",
              });
          }
          return res.status(200).send({
            error: false,
...
router.put("/update-parametri/:id", checkTokenExistence, (req, res, next) => {
  try {
    const userId = req.params.id;
    const updatedData = req.body;
...
router.post(
  ...
  (req, res, next) => {
    try {
      ...
      const insertQuery =
        "INSERT INTO recomandari (recomandare, timp, detalii) VALUES (?, ?, ?)";
      ...
      db.query(insertQuery, insertParams, function (error, results, fields) {
        ...
        const updateQuery =
          "UPDATE Pacienti SET id_recomandare = ? WHERE id_pacient = ?";
        ...
        db.query(updateQuery, updateParams, function (error, results, fields) {
          if (error) {
            ...
            return res
              ...
              .json({
                error: true,
                msg: "Eroare la actualizarea recomandarii pentru pacient",
              });
          }
          return res.status(200).send({
            error: false,
